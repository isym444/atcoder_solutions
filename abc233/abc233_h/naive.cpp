...
auto solve(int N, const std::vector<long long> &x, const std::vector<long long> &y, int Q, const std::vector<long long> &a, const std::vector<long long> &b, const std::vector<long long> &K) {
    // TODO: edit here
}
...
int main() {
    ...
    std::cin >> Q;
    std::vector<long long> a(Q), b(Q), K(Q);
    REP (i, Q) {
        std::cin >> a[i] >> b[i] >> K[i];
    }
