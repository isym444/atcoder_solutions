...
double solve(long long N, int M, const std::vector<long long> &u, const std::vector<long long> &v, const std::vector<long long> &b, const std::vector<long long> &c) {
    // TODO: edit here
}
...
int main() {
    ...
    int M;
    std::cin >> N >> M;
    std::vector<long long> u(M), v(M), b(M), c(M);
    REP (i, M) {
