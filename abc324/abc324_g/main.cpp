...
auto solve(int N, const std::vector<long long> &A, int Q, const std::vector<long long> &t, const std::vector<long long> &s, const std::vector<long long> &x) {
...
int main() {
    ...
    std::cin >> Q;
    std::vector<long long> t(Q), s(Q), x(Q);
    REP (i, Q) {
        std::cin >> t[i] >> s[i] >> x[i];
    }
