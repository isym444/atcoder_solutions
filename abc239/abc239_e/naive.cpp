...
auto solve(int N, int Q, const std::vector<long long> &X, const std::vector<long long> &A, const std::vector<long long> &B, const std::vector<long long> &V, const std::vector<long long> &K) {
    // TODO: edit here
}
...
int main() {
    ...
    int N, Q;
    std::cin >> N;
    std::vector<long long> X(N), A(N - 1), B(N - 1);
    std::cin >> Q;
    std::vector<long long> V(Q), K(Q);
    REP (i, N) {
        std::cin >> X[i];
    }
    REP (i, N - 1) {
