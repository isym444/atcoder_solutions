...
auto solve(int a, int b, const std::vector<long long> &c, const std::vector<long long> &d, const std::vector<long long> &e, const std::vector<long long> &f, const std::vector<long long> &g, const std::vector<long long> &h) {
    // TODO: edit here
}
...
int main() {
    ...
    int a, b;
    std::cin >> a;
    std::vector<long long> c(a), d(a);
    std::cin >> b;
    std::vector<long long> e(b), f(b), g(b), h(b);
    REP (i, a) {
        std::cin >> c[i];
    }
    REP (i, a) {
