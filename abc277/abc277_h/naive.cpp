...
auto solve(long long N, long long M, int Q, const std::vector<long long> &A, const std::vector<long long> &B, const std::vector<long long> &L, const std::vector<long long> &R) {
    // TODO: edit here
}
...
int main() {
    ...
    int Q;
    std::cin >> N >> M >> Q;
    std::vector<long long> A(Q), B(Q), L(Q), R(Q);
    REP (i, Q) {
