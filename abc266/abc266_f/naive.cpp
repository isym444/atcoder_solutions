...
auto solve(int N, const std::vector<long long> &u, const std::vector<long long> &v, int Q, const std::vector<long long> &x, const std::vector<long long> &y) {
    // TODO: edit here
}
