...
long long solve(int N, const std::vector<long long> &T, const std::vector<long long> &X, const std::vector<long long> &Y, const std::vector<long long> &A) {
...
int main() {
    ...
    int N;
    std::cin >> N;
    std::vector<long long> T(N), X(N), Y(N), A(N);
    REP (i, N) {
