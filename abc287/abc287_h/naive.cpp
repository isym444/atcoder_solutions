...
auto solve(long long N, int M, const std::vector<long long> &a, const std::vector<long long> &b, int Q, const std::vector<long long> &s, const std::vector<long long> &t) {
    // TODO: edit here
}
