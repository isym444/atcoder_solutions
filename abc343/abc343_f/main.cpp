...
auto solve(int a, int b, const std::vector<long long> &c, const std::vector<long long> &d, const std::vector<long long> &e, const std::vector<long long> &f) {
...
int main() {
    ...
    std::cin >> b;
    std::vector<long long> d(b), e(b), f(b);
    REP (i, a) {
        std::cin >> c[i];
    }
    REP (i, b) {
