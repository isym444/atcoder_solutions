...
std::vector<auto> solve(long long N, int K, int L, const std::vector<long long> &p, const std::vector<long long> &q, const std::vector<long long> &r, const std::vector<long long> &s) {
...
int main() {
    ...
    int K, L;
    std::cin >> N >> K;
    std::vector<long long> p(K), q(K);
    std::cin >> L;
    std::vector<long long> r(L), s(L);
    REP (i, K) {
        std::cin >> p[i] >> q[i];
    }
    REP (i, L) {
