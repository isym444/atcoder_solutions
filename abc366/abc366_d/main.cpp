...
int main() {
    ...
    ll N, Q;
    cin >> N;
    vector<vector<vector<ll>>> v(N, vector<vector<ll>>(N, vector<ll>(N, 0)));
    ...
    vector<vector<vector<ll>>> prefix = build3DPrefixSum(v, N);
    ...
    foi(0,Q){
        ...
        lz--;
        rz--;
        cout << getSubgridSum3D(prefix, lx, ly, lz, rx, ry, rz) << endl;
    }
