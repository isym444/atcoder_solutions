...
auto solve(long long N, int M, int Q, const std::vector<long long> &A, const std::vector<long long> &B, const std::vector<long long> &C, const std::vector<long long> &X, const std::vector<long long> &Y) {
