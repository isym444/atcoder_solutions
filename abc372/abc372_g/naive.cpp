...
auto solve(int a, const std::vector<long long> &b, const std::vector<std::vector<long long> > &c, const std::vector<std::vector<long long> > &d, const std::vector<std::vector<long long> > &e) {
    // TODO: edit here
}
...
int main() {
    ...
    std::vector<std::vector<long long> > c(a, std::vector<long long>((b_i))), d(a, std::vector<long long>((b_i))), e(a, std::vector<long long>((b_i)));
    REP (i, a) {
        std::cin >> b[i];
        REP (j, b_i) {
