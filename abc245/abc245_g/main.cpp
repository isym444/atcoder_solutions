...
std::vector<auto> solve(int N, int M, long long K, int L, const std::vector<long long> &A, const std::vector<long long> &B, const std::vector<long long> &U, const std::vector<long long> &V, const std::vector<long long> &C) {
...
int main() {
    ...
    std::cin >> M;
    std::vector<long long> U(M), V(M), C(M);
    std::cin >> K >> L;
