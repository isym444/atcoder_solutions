...
long long solve(int N, const std::vector<long long> &P, const std::vector<long long> &A, const std::vector<long long> &B, const std::vector<long long> &C) {
    // TODO: edit here
}
...
int main() {
    ...
    int N;
    std::cin >> N;
    std::vector<long long> P(N), A(N), B(N), C(N);
    REP (i, N) {
        std::cin >> P[i];
    }
    REP (i, N) {
