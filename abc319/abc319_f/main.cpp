...
bool solve(int N, const std::vector<long long> &p, const std::vector<long long> &t, const std::vector<long long> &s, const std::vector<long long> &g) {
...
int main() {
    ...
    int N;
    std::cin >> N;
    std::vector<long long> p(N - 1), t(N - 1), s(N - 1), g(N - 1);
    REP (i, N - 1) {
