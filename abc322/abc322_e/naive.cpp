...
long long solve(int a, const std::vector<long long> &b, const std::vector<long long> &c, const std::vector<long long> &d, const std::vector<long long> &e, long long f, long long g) {
    // TODO: edit here
}
...
int main() {
    ...
    long long f, g;
    std::cin >> a;
    std::vector<long long> b(a), c(a), d(a), e(a);
    REP (i, a) {
