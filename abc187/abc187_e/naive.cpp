...
auto solve(int N, const std::vector<long long> &a, const std::vector<long long> &b, int Q, const std::vector<long long> &t, const std::vector<long long> &e, const std::vector<long long> &x) {
    // TODO: edit here
}
...
int main() {
    ...
    std::cin >> Q;
    std::vector<long long> t(Q), e(Q), x(Q);
    REP (i, Q) {
        std::cin >> t[i] >> e[i] >> x[i];
    }
