...
auto solve(int N, int Q, const std::vector<long long> &a, const std::vector<long long> &b, const std::vector<long long> &k) {
    // TODO: edit here
}
