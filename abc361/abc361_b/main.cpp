...
// bool solve(long long a, long long b, long long c, long long d, long long e, long long f, long long g, long long h, long long i, long long j, long long k, long long l) {
//     if(a==g&&b==h&&c==i){
//         return true;
//     }
//     ll from01, from02;
//     from01 = pow((a*a+b*b),2)+(c*c);
//     from02 = pow((g*g+h*h),2)+(i*i);
//     if(from02<from01){
//         swap(a,g);
//         swap(b,h);
//         swap(c,i);
...
//     if(g>a&&h>b&&i>c&&j<d&&k<e&&l<f) return true;
//     if(g<d&&h<e&&i<f&&j>a&&k>b&&l>c) return true;
//     return false;
// }
