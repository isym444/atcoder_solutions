...
//     }
//     dbg(d);
//     //d is current out of all the possibile selections of N items i.e. all possible combos of actually truthful people
//     bool ok = true;
//     rep(j,n) {
//         //if person is supposedly truthful, check for contradictions
//         if (d[j]) {
//             rep(k,n) {
//                 if (g[j][k] == -1) continue;
//                 //if g[j][k] == 0, then don't have to consider what they are saying, just consider what all supposedly truthful people are saying matches up
