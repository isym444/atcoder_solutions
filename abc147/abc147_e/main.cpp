...
long long solve(auto a, auto b, const std::vector<auto> &c, const std::vector<auto> &d, const std::vector<std::vector<auto> > &e, auto f) {
...
int main() {
    ...
    std::cin >> a;
    std::vector<auto> d(a);
    std::vector<std::vector<auto> > e(a, std::vector<auto>((a)));
    std::cin >> b;
    std::vector<auto> c(b);
    REP (i, b) {
        std::cin >> c[i];
