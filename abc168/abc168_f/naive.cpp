...
std::string solve(int N, int M, const std::vector<long long> &A, const std::vector<long long> &B, const std::vector<long long> &C, const std::vector<long long> &D, const std::vector<long long> &E, const std::vector<long long> &F) {
    // TODO: edit here
}
...
int main() {
    ...
    std::cin >> M;
    std::vector<long long> D(M), E(M), F(M);
    REP (i, N) {
        std::cin >> A[i] >> B[i] >> C[i];
    }
    REP (i, M) {
