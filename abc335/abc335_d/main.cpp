...
void solve(long long N) {
    vector<vector<string>> ans(N, vector<string>(N,"-1"));
    /* ll loc::x=0;
    ll loc::y=0;
    char loc::dir='r'; */
    ll counter=1;
    while(counter<pow(N,2)){
        ...
        cerr<<"Y: "<<loc::y<<endl;
        cerr<<"D: "<<loc::dir<<endl;
        cerr << isvalid(loc::x,N,loc::y,N) << endl; */
        if(isvalid(loc::y,N,loc::x,N)==0){
            if(loc::dir=='r'){
                loc::dir='d';
                loc::x--;
                loc::y++;
        ...
        else if(isvalid(loc::x,N,loc::y,N)){
                if(ans[loc::y][loc::x]!="-1"){
                    if(loc::dir=='r'){
                    loc::dir='d';
                    loc::x--;
                    loc::y++;
                ...
                /* cerr << "reached" << endl;
                cerr << ans[0] << endl; */
                ans[loc::y][loc::x]=to_string(counter);
                if(loc::dir=='r') loc::x++;
                else if(loc::dir=='l') loc::x--;
                else if(loc::dir=='u') loc::y--;
                else if(loc::dir=='d') loc::y++;
                counter++;
            }
        }
        //counter++;
