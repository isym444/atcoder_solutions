    ...
    while(q--){
        ...
        if(qt==1){
            ...
            if(dir=='U'){
                /* x.pb(x[x.size()-1]);
                y.pb(y[y.size()-1]+1); */
                dqx.push_front(dqx[0]);
                dqy.push_front(dqy[0]+1);
            }
            else if(dir=='D'){
                /* x.pb(x[x.size()-1]);
                y.pb(y[y.size()-1]-1); */
                ...
                /* x.pb(x[x.size()-1]+1);
                y.pb(y[y.size()-1]); */
                dqx.push_front(dqx[0]+1);
                dqy.push_front(dqy[0]);
            ...
            int temp;
            cin >> temp;
            /* cout << x[x.size()-temp] << " " << y[y.size()-temp] << endl; */
            cout << dqx[temp-1] << " " << dqy[temp-1] << endl;
        }
    }
