...
auto solve(int a, int b, const std::vector<long long> &c, const std::vector<std::vector<long long> > &d, const std::vector<long long> &e, const std::vector<long long> &f) {
    // TODO: edit here
}
