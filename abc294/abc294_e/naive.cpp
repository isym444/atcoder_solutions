...
long long solve(long long a, int b, int c, const std::vector<long long> &d, const std::vector<long long> &e, const std::vector<long long> &f, const std::vector<long long> &g) {
    // TODO: edit here
}
