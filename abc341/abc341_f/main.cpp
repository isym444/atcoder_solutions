...
long long solve(int N, int M, const std::vector<long long> &u, const std::vector<long long> &v, const std::vector<long long> &W, const std::vector<long long> &A) {
    // TODO: edit here
}
