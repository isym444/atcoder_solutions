...
long long solve(int N, int Q, long long X, const std::vector<long long> &P, const std::vector<long long> &C, const std::vector<long long> &L, const std::vector<long long> &R) {
    // TODO: edit here
}
...
int main() {
    ...
    std::cin >> Q;
    std::vector<long long> C(Q), L(Q), R(Q);
    std::cin >> X;
    REP (i, N) {
        std::cin >> P[i];
    }
