...
auto solve(long long N, int M, int Q, const std::vector<long long> &a, const std::vector<long long> &b, const std::vector<long long> &c, const std::vector<long long> &u, const std::vector<long long> &v, const std::vector<long long> &w) {
    // TODO: edit here
}
...
int main() {
    ...
    std::cin >> Q;
    std::vector<long long> u(Q), v(Q), w(Q);
    REP (i, M) {
        std::cin >> a[i] >> b[i] >> c[i];
    }
    REP (i, Q) {
