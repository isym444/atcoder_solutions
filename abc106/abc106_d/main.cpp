...
auto solve(long long N, int M, int Q, const std::vector<long long> &L, const std::vector<long long> &R, const std::vector<long long> &p, const std::vector<long long> &q) {
