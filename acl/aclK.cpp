...
//h S represents a node/segment in the tree i.e. a segment in the original array
struct S {
    int a;
};
...
int main() {
    ...
    foi(0,q){
        ...
        if(t==1){
            ...
            int l,r;
            cin >> l >> r;
            //debug ?I suppose due to zero indexing to < rather than <=
            l--;
            cout << mysegtree.prod(l,r).a << endl;
        }
        else{
            int x,v;
            cin >> x >> v;
