...
auto solve(int N, int Q, const std::vector<long long> &A, const std::vector<long long> &T, const std::vector<long long> &L, const std::vector<long long> &R) {
    // TODO: edit here
}
...
int main() {
    ...
    std::cin >> Q;
    std::vector<long long> T(Q), L(Q), R(Q);
    REP (i, N) {
        std::cin >> A[i];
    }
    REP (i, Q) {
