...
auto solve(int T, const std::vector<long long> &N, const std::vector<long long> &M, const std::vector<long long> &A, const std::vector<long long> &B) {
...
int main() {
    ...
    int T;
    std::cin >> T;
    std::vector<long long> N(T), M(T), A(T), B(T);
    REP (i, T) {
