...
auto solve(int N, int Q, const std::vector<long long> &a, const std::vector<long long> &b, const std::vector<long long> &c, const std::vector<long long> &d, const std::vector<long long> &x, const std::vector<long long> &y, const std::vector<long long> &u, const std::vector<long long> &v) {
...
int main() {
    ...
    int N, Q;
    std::cin >> N;
    std::vector<long long> a(N - 1), b(N - 1), c(N - 1), d(N - 1);
    std::cin >> Q;
    std::vector<long long> x(Q), y(Q), u(Q), v(Q);
    REP (i, N - 1) {
