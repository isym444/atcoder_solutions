...
auto solve(int N, int Q, const std::vector<long long> &S, const std::vector<long long> &T, const std::vector<long long> &X, const std::vector<long long> &D) {
    // TODO: edit here
}
...
int main() {
    ...
    int N, Q;
    std::cin >> N;
    std::vector<long long> S(N), T(N), X(N);
    std::cin >> Q;
