...
long long solve(long long a, int b, const std::vector<long long> &c, const std::vector<std::vector<long long> > &d, const std::vector<long long> &e) {
    // TODO: edit here
}
