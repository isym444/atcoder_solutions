...
bool solve(int a, long long b, const std::vector<long long> &c, const std::vector<long long> &d, const std::vector<std::vector<long long> > &e) {
    // TODO: edit here
}
...
int main() {
    ...
    std::vector<std::vector<long long> > e(a, std::vector<long long>((d_i)));
    std::cin >> b;
    REP (i, a) {
        std::cin >> c[i] >> d[i];
        REP (j, d_i) {
