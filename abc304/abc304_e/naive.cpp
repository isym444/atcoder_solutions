...
auto solve(long long N, int M, const std::vector<long long> &u, const std::vector<long long> &v, int K, const std::vector<long long> &x, const std::vector<long long> &y, int Q, const std::vector<long long> &p, const std::vector<long long> &q) {
    // TODO: edit here
}
