...
auto solve(int N, const std::vector<long long> &A, int M, const std::vector<long long> &B, int L, const std::vector<long long> &C, int Q, const std::vector<long long> &X) {
    // TODO: edit here
}
