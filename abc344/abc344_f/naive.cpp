...
long long solve(int N, const std::vector<std::vector<long long> > &P, const std::vector<std::vector<long long> > &R, const std::vector<std::vector<long long> > &D) {
    // TODO: edit here
}
...
int main() {
    ...
    int N;
    std::cin >> N;
    std::vector<std::vector<long long> > P(N, std::vector<long long>((N))), R(N, std::vector<long long>((N - 1))), D(N - 1, std::vector<long long>((N)));
    REP (j, N) {
        REP (i, N) {
            std::cin >> P[j][i];
        }
