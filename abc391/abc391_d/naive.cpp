...
auto solve(int N, long long W, const std::vector<long long> &X, const std::vector<long long> &Y, int Q, const std::vector<long long> &T, const std::vector<long long> &A) {
    // TODO: edit here
}
