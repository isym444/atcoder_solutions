    ...
    while(A.size()>1){
        ...
        foi(0,A.size()/3){
            ...
            if(zeros>ones){
                ...
                fok(0,3){
                    if(A[3*i+k]==0){
                        flipzerocost.pb(AP[3*i+k].sec);
                    }
                }
                sort(all(flipzerocost));
                if(zeros==2){
                    newAP.pb(mp(0,flipzerocost[0]));
                }
                if(zeros==3){
                    newAP.pb(mp(0,flipzerocost[0]+flipzerocost[1]));
                }
                ...
                fok(0,3){
                    if(A[3*i+k]==1){
                        fliponecost.pb(AP[3*i+k].sec);
                    }
                }
                sort(all(fliponecost));
                if(ones==2){
                    newAP.pb(mp(1,fliponecost[0]));
                }
                if(ones==3){
                    newAP.pb(mp(1,fliponecost[0]+fliponecost[1]));
                }
            }
        }
        A = newA;
