...
auto solve(int N, int Q, const std::vector<long long> &A, const std::vector<long long> &B, const std::vector<long long> &l, const std::vector<long long> &r, const std::vector<long long> &L, const std::vector<long long> &R) {
    // TODO: edit here
}
...
int main() {
    ...
    std::cin >> Q;
    std::vector<long long> l(Q), r(Q), L(Q), R(Q);
    REP (i, N) {
        std::cin >> A[i];
    }
    REP (i, N) {
    ...
    REP (i, Q) {
        std::cin >> l[i] >> r[i] >> L[i] >> R[i];
    }
    auto ans = solve(N, Q, A, B, l, r, L, R);
    REP (i, Q) {
        std::cout << a[i] << '\n';
    }
