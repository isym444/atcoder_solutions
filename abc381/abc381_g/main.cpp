...
auto solve(long long a, long long b, long long c, long long d, long long e, long long f, long long g, long long h, long long m, long long n) {
...
int main() {
    ...
    long long a, b, c, d, e, f, g, h, m, n;
    std::cin >> a >> b >> c >> d >> e >> f >> g >> h >> m >> n;
    auto ans = solve(a, b, c, d, e, f, g, h, m, n);
    REP (i, a) {
        std::cout << o[i] << '\n';
    }
