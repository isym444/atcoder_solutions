...
double solve(int N, int M, const std::vector<long long> &X, const std::vector<long long> &Y, const std::vector<long long> &P, const std::vector<long long> &Q) {
