...
auto solve(int a, int b, const std::vector<long long> &c, const std::vector<long long> &d, const std::vector<long long> &e, const std::vector<long long> &f, const std::vector<long long> &g, const std::vector<long long> &h, const std::vector<long long> &m) {
...
int main() {
    ...
    std::cin >> b;
    std::vector<long long> d(b), e(b), f(b), g(b), h(b), m(b);
    REP (i, a) {
        std::cin >> c[i];
    }
    REP (i, b) {
        std::cin >> d[i] >> e[i] >> f[i] >> g[i] >> h[i] >> m[i];
    }
    auto ans = solve(a, b, c, d, e, f, g, h, m);
    REP (i, b) {
        std::cout << n[i] << '\n';
    }
