...
int main(){
    ...
    vll A(N);
    cin >> A;
    // ll sizeOfBoard = (ll)1e4*2+4;
    bitset<10000*2+4> dpx;
    bitset<10000*2+4> dpy;
    dpx.set(10000+A[0]);
    dpy.set(10000);
    foi(1,N){
        //modify y
        if(i%2==1){
            //or ensures you combine both the possible directions of movement of size A[i]
            dpy = (dpy << A[i] | dpy >> A[i]);
        }
        else{
            //modify x
...
//         }
//     }
//     if (dpx[10000 + x] == 1 && dpy[10000 + y] == 1){
//         cout << "Yes" << endl;
//     } else {
//         cout << "No" << endl;
//     }
