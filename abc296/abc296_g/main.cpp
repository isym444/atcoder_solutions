...
auto solve(int N, const std::vector<long long> &X, const std::vector<long long> &Y, int Q, const std::vector<long long> &A, const std::vector<long long> &B) {
