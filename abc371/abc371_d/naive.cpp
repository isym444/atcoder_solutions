...
auto solve(int N, const std::vector<long long> &X, const std::vector<long long> &P, int Q, const std::vector<long long> &L, const std::vector<long long> &R) {
    // TODO: edit here
}
