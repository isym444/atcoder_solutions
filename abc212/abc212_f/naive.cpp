...
auto solve(long long N, int M, int Q, const std::vector<long long> &A, const std::vector<long long> &B, const std::vector<long long> &S, const std::vector<long long> &T, const std::vector<long long> &X, const std::vector<long long> &Y, const std::vector<long long> &Z) {
    // TODO: edit here
}
...
int main() {
    ...
    int M, Q;
    std::cin >> N >> M;
    std::vector<long long> A(M), B(M), S(M), T(M);
    std::cin >> Q;
    std::vector<long long> X(Q), Y(Q), Z(Q);
    REP (i, M) {
