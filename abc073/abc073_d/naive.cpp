...
long long solve(long long N, int M, int R, const std::vector<long long> &r, const std::vector<long long> &A, const std::vector<long long> &B, const std::vector<long long> &C) {
    // TODO: edit here
}
