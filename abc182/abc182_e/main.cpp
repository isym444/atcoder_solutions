...
long long solve(long long H, long long W, int N, int M, const std::vector<long long> &A, const std::vector<long long> &B, const std::vector<long long> &C, const std::vector<long long> &D) {
