...
auto solve(long long a, int b, const std::vector<long long> &c, const std::vector<long long> &d, long long e, const std::vector<long long> &f, const std::vector<long long> &g) {
    // TODO: edit here
}
...
int main() {
    ...
    long long e;
    std::cin >> a >> b;
    std::vector<long long> c(b), d(b), f(b), g(b);
    REP (i, b) {
        std::cin >> c[i] >> d[i];
    }
    std::cin >> e;
