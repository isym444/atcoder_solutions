...
auto solve(int Q, const std::vector<long long> &X, const std::vector<long long> &Y, const std::vector<long long> &A, const std::vector<long long> &B) {
    // TODO: edit here
}
...
int main() {
    ...
    int Q;
    std::cin >> Q;
    std::vector<long long> X(Q), Y(Q), A(Q), B(Q);
    REP (i, Q) {
