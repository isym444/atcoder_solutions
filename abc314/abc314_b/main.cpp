...
std::vector<auto> solve(int a, const std::vector<long long> &b, const std::vector<std::vector<long long> > &c, long long d) {
...
int main() {
    ...
    std::vector<std::vector<long long> > c(a, std::vector<long long>((b_i)));
    REP (i, a) {
        std::cin >> b[i];
        REP (j, b_i) {
            std::cin >> c[i][j];
