...
//     cout << s << endl;
// }
// std::string solve(long long N, std::string S, int Q, const std::vector<long long> &t, const std::vector<long long> &x, const std::vector<char> &c) {
...
//     }
//     ll ind = 0;
//     if(lastiupper>lastilower){
//         ind =1;
//     }
//     ll lasti = max(lastiupper,lastilower);
//     foi(0,Q){
//         if(t[i]==1){
//             S[x[i]-1]=c[i];
//         }
