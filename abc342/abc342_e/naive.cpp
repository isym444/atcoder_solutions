...
auto solve(long long N, int M, const std::vector<long long> &l, const std::vector<long long> &d, const std::vector<long long> &k, const std::vector<long long> &c, const std::vector<long long> &A, const std::vector<long long> &B) {
    // TODO: edit here
}
...
int main() {
    ...
    int M;
    std::cin >> N >> M;
    std::vector<long long> l(M), d(M), k(M), c(M), A(M), B(M);
    REP (i, M) {
