...
int main() {
    ...
    // TODO: edit here
    ll n,q;
    // std::string test = "hello,world,this,test";
    cerr << split("hello,world,this,test", ',') << endl;
    cerr << digits_low_to_high(8210) << endl;
    cerr << digits_high_to_low(8210) << endl;
    std::cin >> n;
    cin >> q;
    map<ll,multiset<ll>> boxes;
    map<ll,set<ll>> card;
    foi(0,q){
        ll type,fq,sq;
        cin >> type;
