...
auto solve(int N, int Q, const std::vector<long long> &A, const std::vector<long long> &L, const std::vector<long long> &R, const std::vector<long long> &X) {
    // TODO: edit here
}
...
int main() {
    ...
    std::cin >> Q;
    std::vector<long long> L(Q), R(Q), X(Q);
    REP (i, N) {
        std::cin >> A[i];
    }
    REP (i, Q) {
