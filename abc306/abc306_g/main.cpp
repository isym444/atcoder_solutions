...
auto solve(int a, const std::vector<long long> &b, const std::vector<long long> &c, const std::vector<std::vector<long long> > &d, const std::vector<std::vector<long long> > &e) {
...
int main() {
    ...
    std::vector<std::vector<long long> > d(a, std::vector<long long>((c_i))), e(a, std::vector<long long>((c_i)));
    REP (i, a) {
        std::cin >> b[i] >> c[i];
        REP (j, c_i) {
            std::cin >> d[i][j] >> e[i][j];
