...
long long solve(int N, int M, const std::vector<long long> &X, const std::vector<long long> &Y, const std::vector<long long> &A, const std::vector<long long> &B, const std::vector<long long> &Z) {
...
int main() {
    ...
    std::cin >> M;
    std::vector<long long> A(M), B(M), Z(M);
    REP (i, N) {
        std::cin >> X[i];
    }
    REP (i, N) {
