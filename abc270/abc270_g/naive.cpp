...
auto solve(int a, const std::vector<long long> &b, const std::vector<long long> &c, const std::vector<long long> &d, const std::vector<long long> &e, const std::vector<long long> &f) {
    // TODO: edit here
}
...
int main() {
    ...
    int a;
    std::cin >> a;
    std::vector<long long> b(a), c(a), d(a), e(a), f(a);
    REP (i, a) {
