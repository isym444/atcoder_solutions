...
//returns vvll of distances from all nodes to all other nodes
...
// auto solve(int N, int Q, const std::vector<long long> &a, const std::vector<long long> &b, const std::vector<long long> &c, const std::vector<long long> &d) {
...
int main() {
    ...
    REP (i, Q) {
        ...
        c--;
        d--;
        // ll lca = tree.lowest_common_ancestor(c,d);
        // ll lcadepth = tree.depth[lca];
        // ll cdepth = tree.depth[c];
        // ll ddepth = tree.depth[d];
        ll dd = tree.path_length(c,d);
        // dbg(bfs(0));
        //h remove as TLE
        // dbg(i);
        // if(depth[c]%2!=depth[d]%2) cout << "Road" << endl;
        // else cout << "Town" << endl;
        // dbg(dd);
        if(dd%2==0) cout << "Town" << endl;
        else cout << "Road" << endl;
        // cerr << c+1 << " " << d+1 << endl;
        // dbg(shortest);
        // if(shortest%2==0){
